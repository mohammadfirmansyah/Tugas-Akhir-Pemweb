                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" id="stasAsal" name="stasAsal">
                                ...
                                <option value="Stasiun Kota Baru Malang" <?php if (set_value('stasAsal') == "Stasiun Kota Baru Malang") : echo "selected";
                                                        endif; ?>>Stasiun Kota Baru Malang</option>
                                <option value="Stasiun Kota Lama Malang" <?php if (set_value('stasAsal') == "Stasiun Kota Lama Malang") : echo "selected";
                                                            endif; ?>>Stasiun Kota Lama Malang</option>
                                <option value="Stasiun Blimbing Malang" <?php if (set_value('stasAsal') == "Stasiun Blimbing Malang") : echo "selected";
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" id="stasTujuan" name="stasTujuan">
                                <option value="Belum Memilih" selected disabled>Pilih</option>
                                <option value="Stasiun Gubeng Surabaya" <?php if (set_value('stasTujuan') == "Stasiun Gubeng Surabaya") : echo "selected";
                                                        endif; ?>>Stasiun Gubeng Surabaya</option>
                                <option value="Stasiun Tugu Yogyakarta" <?php if (set_value('stasTujuan') == "Stasiun Tugu Yogyakarta") : echo "selected";
                                                            endif; ?>>Stasiun Tugu Yogyakarta</option>
                                <option value="Stasiun Gambir Jakarta" <?php if (set_value('stasTujuan') == "Stasiun Gambir Jakarta") : echo "selected";
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" id="JadwalPesanan" name="JadwalPesanan">
                                <option value="Belum Memilih" selected disabled>Pilih</option>
                                <option value="Pagi" <?php if (set_value('JadwalPesanan') == "Pagi") : echo "selected";
                                                        endif; ?>>Pagi</option>
                                <option value="Siang" <?php if (set_value('JadwalPesanan') == "Siang") : echo "selected";
                                                            endif; ?>>Siang</option>
                                <option value="Malam" <?php if (set_value('JadwalPesanan') == "Malam") : echo "selected";
                                                        endif; ?>>Malam</option>
                            </select>
                            <small class="text-danger">
